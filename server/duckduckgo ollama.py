...
if __name__ == "__main__":
    ...
    print("Welcome to the Ollama-Enhanced Fact Checker!")
    print("Enter a statement to fact-check (or 'quit' to exit):")
    ...
    print("\nThank you for using the Ollama-Enhanced Fact Checker!")
